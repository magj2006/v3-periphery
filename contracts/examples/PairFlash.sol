...
import 'node_modules/@fikaswap/v3-core/contracts/interfaces/callback/IFikaswapV3FlashCallback.sol';
import 'node_modules/@fikaswap/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the Fikaswap V3 flash function
contract PairFlash is IFikaswapV3FlashCallback, PeripheryPayments {
    ...
    function fikaswapV3FlashCallback(
        uint256 fee0,
        uint256 fee1,
        bytes calldata data
    ) external override {
    ...
    /// @notice Calls the pools flash function with data needed in `fikaswapV3FlashCallback`
