...
import 'node_modules/@fikaswap/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IFikaswapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IFikaswapV3Pool) {
        return IFikaswapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IFikaswapV3SwapCallback
    function fikaswapV3SwapCallback(
        ...
        IFikaswapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IFikaswapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
