...
import "./interfaces/IFikaswapV3Pool.sol";
...
import "./interfaces/IFikaswapV3PoolDeployer.sol";
import "./interfaces/IFikaswapV3Factory.sol";
import "./interfaces/IERC20Minimal.sol";
import "./interfaces/callback/IFikaswapV3MintCallback.sol";
import "./interfaces/callback/IFikaswapV3SwapCallback.sol";
import "./interfaces/callback/IFikaswapV3FlashCallback.sol";

contract FikaswapV3Pool is IFikaswapV3Pool, NoDelegateCall {
    ...
    /// @inheritdoc IFikaswapV3PoolImmutables
    ...
    /// @inheritdoc IFikaswapV3PoolState
    ...
    /// @dev Prevents calling a function from anyone except the address returned by IFikaswapV3Factory#owner()
    modifier onlyFactoryOwner() {
        require(msg.sender == IFikaswapV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IFikaswapV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IFikaswapV3PoolDerivedState
    ...
    /// @inheritdoc IFikaswapV3PoolActions
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        IFikaswapV3MintCallback(msg.sender).fikaswapV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IFikaswapV3SwapCallback(msg.sender).fikaswapV3SwapCallback(amount0, amount1, data);
        ...
        noDelegateCall
    {
        ...
        IFikaswapV3FlashCallback(msg.sender).fikaswapV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IFikaswapV3PoolOwnerActions
